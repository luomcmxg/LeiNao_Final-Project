...
def main():
 ...
 # )
  ...
  # 设置优化器
  optimzer = torch.optim.SGD(unet.parameters(), lr=0.05,momentum=0.9,weight_decay=0.03)
  scheduler = torch.optim.lr_scheduler.MultiStepLR(optimzer,  milestones = [150, 1000], gamma = 0.05, last_epoch=-1)
